...
export const pokemon: Pokemon[] = [
    ...
    {name: 'Hypno', catch: 50, bait: 75, rock: 70, png: 'https://img.pokemondb.net/sprites/scarlet-violet/normal/hypno.png', link: 'https://pokemondb.net/pokedex/hypno'},
    ...
    {name: 'Sneasel', catch: 80, bait:70, rock: 30, png: 'https://img.pokemondb.net/sprites/scarlet-violet/normal/sneasel.png', link: 'https://pokemondb.net/pokedex/sneasel'},
    ...
    {name: 'Medicham', catch: 65, bait:80, rock: 40, png: 'https://img.pokemondb.net/sprites/scarlet-violet/normal/medicham.png', link: 'https://pokemondb.net/pokedex/medicham'},
    ...
    {name: 'Altaria', catch: 65, bait:70, rock: 40, png: 'https://img.pokemondb.net/sprites/scarlet-violet/normal/altaria.png', link: 'https://pokemondb.net/pokedex/altaria'},
    ...
    {name: 'Weavile', catch: 55, bait:70, rock: 70, png: 'https://img.pokemondb.net/sprites/scarlet-violet/normal/weavile.png', link: 'https://pokemondb.net/pokedex/weavile'},
    ...
    {name: 'Volcarona', catch: 55, bait:70, rock: 70, png: 'https://img.pokemondb.net/sprites/scarlet-violet/normal/volcarona.png', link: 'https://pokemondb.net/pokedex/volcarona'},
    ...
    {name: 'Salazzle', catch: 75, bait:70, rock: 50, png: 'https://img.pokemondb.net/sprites/scarlet-violet/normal/salazzle.png', link: 'https://pokemondb.net/pokedex/salazzle'},
    ...
    {name: 'Lokix', catch: 55, bait:70, rock: 85, png: 'https://img.pokemondb.net/sprites/scarlet-violet/normal/lokix.png', link: 'https://pokemondb.net/pokedex/lokix'},
    ...
    {name: 'Garganacl', catch: 55, bait:60, rock: 50, png: 'https://img.pokemondb.net/sprites/scarlet-violet/normal/garganacl.png', link: 'https://pokemondb.net/pokedex/gargancal'},
    ...
    {name: 'Scream Tail', catch: 60, bait:65, rock: 40, png: 'https://img.pokemondb.net/sprites/scarlet-violet/normal/scream-tail.png', link: 'https://pokemondb.net/pokedex/scream-tail'},
    ...
    {name: 'Iron Bundle', catch: 65, bait:60, rock: 40, png: 'https://img.pokemondb.net/sprites/scarlet-violet/normal/iron-bundle.png', link: 'https://pokemondb.net/pokedex/iron-bundle'},
    ...
    {name: 'Iron Jugulis', catch: 40, bait:60, rock: 60, png: 'https://img.pokemondb.net/sprites/scarlet-violet/normal/iron-jugulis.png', link: 'https://pokemondb.net/pokedex/iron-jugulis'},
    {name: 'Iron Moth', catch: 50, bait:65, rock: 45, png: 'https://img.pokemondb.net/sprites/scarlet-violet/normal/iron-moth.png', link: 'https://pokemondb.net/pokedex/iron-moth'},
    ...
    {name: 'Roaring Moon', catch: 40, bait:50, rock: 35, png: 'https://img.pokemondb.net/sprites/scarlet-violet/normal/roaring-moon.png', link: 'https://pokemondb.net/pokedex/roaring-moon'},
    {name: 'Iron Valiant', catch: 40, bait: 50, rock: 35, png: 'https://img.pokemondb.net/sprites/scarlet-violet/normal/iron-valiant.png', link: 'https://pokemondb.net/pokedex/iron-valiant'},
]
